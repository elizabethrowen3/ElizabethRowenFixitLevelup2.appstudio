...
const cacheName = 'ElizabethRowenFixitLevelup2-2020-09-25 15:48:27.687021'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'ElizabethRowenFixitLevelup2'.length) === 'ElizabethRowenFixitLevelup2') {
